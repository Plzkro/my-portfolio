      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm mb-4">
            &copy; 2025 Raúl Vergara Leiva. Todos los derechos reservados.
          </p>
          <div className="flex justify-center space-x-6">
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-1.367-.056-2.297-1.237-2.297-1.237 0-1.927 1.11-1.927 2.28v5.604h-3v-11h3v1.765c.397-.673 1.256-1.237 2.367-1.237 2.404 0 3.127 1.79 3.127 4.093v6.458z" />
              </svg>
              LinkedIn
            </a>
            ...
            {/* Email */}
            <a
              href="mailto:raul.vergara1@mail.udp.cl"
              className="hover:text-blue-400 transition duration-300 flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
